...
var log = (0, logger_js_1.default)("cli");
var program = new commander_1.Command();
program
    .name("ts-tool")
    .description(chalk_1.default.cyanBright("A ts cli tool with rust-like error output"))
    .version("0.1.0");
program
    .command("check [file]")
...
program.on("command:*", function () {
    log.error("Unknown command: ".concat(program.args.join(" ")));
    console.log();
    program.help();
});
